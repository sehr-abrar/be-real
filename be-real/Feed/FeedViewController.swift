...
class FeedViewController: UIViewController {
    ...
    private func queryPosts(completion: (() -> Void)? = nil) {
        ...
        let query = Post.query()
            .include("user")                           // Include the user object
            .order([.descending("createdAt")])         // Sort by newest first
            .where("createdAt" >= yesterdayDate)       // Only posts from the last 24 hours
            .limit(10)                                 // Maximum 10 posts
